...
<body>
	...
	<!-- 한글을 클릭하면 language=ko가 서버로 전달 -->
		...
		<form id="newProduct" name="newProduct" enctype="multipart/form-data"
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="radio" id="condition" name="condition" value="New" checked> <fmt:message key="condition_New" />  
