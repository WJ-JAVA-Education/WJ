...
public class GmailSend {
	...
	private static class SMTPAuthenticator extends Authenticator {
		public PasswordAuthentication getPasswordAuthentication() {
			//지메일 아이디 , 비밀번호
			return new PasswordAuthentication("jspstudy2", "090908sw??");
		}
	}
	
	public static void send(String title, String content, String toEmail) {
		Properties p = new Properties();
		p.put("mail.smtp.user", "jspstudy2@gmail.com"); //본인 지메일
		...
		try {
			...
			Address fromAddr = new InternetAddress("jspstudy2@gmail.com","JSPStudy"); 
	...
	public static void main(String[] args) {
		...
		send(title, content, "simba222@naver.com");
