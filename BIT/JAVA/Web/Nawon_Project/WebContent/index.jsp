    ...
    <div id="contents">
        ...
        <div id="img_slider" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="https://picsum.photos/1000/499" class="d-block w-100"	alt="..." />
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
              <img src="https://picsum.photos/1000/498" class="d-block w-100"	alt="..." />
              <div class="carousel-caption d-none d-md-block">
      ...
      <div id="footer">
        ...
        <div class="footer_center">
          <ol>
            <a href="#"><li>개인정보 취급방침</li></a>
            <li>사업자 등록증</li>
            <li>대구 --시 00구 00 동 00로</li>
            <li>대표번호 : 000-000-0000</li>
            <li>Fax : 000-000-0000</li>
          </ol>
        </div>
        <div class="copyright">
          Copyright© 2021 Nawon ENG. ALL RIGHTS RESERVED. Designed by J
        </div>
      </div>
    </div>
