										...
										<div class="row">
											<div class="col-12 col-lg-6">
												<div class="form-group">
													<input type="text" class="form-control" name="contact-name" placeholder="Name" value="${sessionScope.userID}">
												</div>
											</div>
											<div class="col-12 col-lg-6">
												<div class="form-group">
													<input type="email" class="form-control" name="contact-email" placeholder="Email" value ="${sessionScope.userEmail}">
												</div>
											</div>
											<div class="col-12">
												<div class="form-group">
											...
											<div class="col-12">
												...
												<input type="hidden" name="adminEmail" value="jaewoo6214010@gmail.com">
											</div>
										</div>
									</form>
								</div>
