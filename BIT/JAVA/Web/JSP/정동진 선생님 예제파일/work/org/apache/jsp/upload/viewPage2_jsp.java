 ...
 * Generated at: 2020-04-24 02:08:31 UTC
...
public final class viewPage2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	try{
		...
		//요청 정보, 저장되는 위치, 크기
		//같은 이름의 파일이 올라왔을때, 2번째올리는 파일에 인덱스 값을 넣어버림 DefaultFileRenamePolicy
		//request객체는 더이상 아무런 요청 정보가 없다.
		//이 객체가 만들어지는 그 시점이 클라이언트가 올린 데이터가 서버에 저장된다.
