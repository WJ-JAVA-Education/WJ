				...
				<form name="newProduct" action="./processUpdateProduct.jsp"
					...
					<div class="form-group row">
						...
						<script type="text/javascript">
							...
							var condition = '<%=rs.getString("p_condition")%>';
							//console.log(condition); 
							switch(condition.toLowerCase()){ //소문자로 변환값을 비교
							case "new": radios[0].checked = true; break;
							case "old": radios[1].checked = true; break;
							case "refurbished": radios[2].checked = true; break;
							}
						</script>
					</div>
					<div class="form-group row">
